...
with open('./plots/comparison/one-well-different-conditions/{}.pkl'.format(emb), 'wb') as f:
...
plt.savefig('./plots/comparison/one-well-different-conditions/comp_{}.pdf'.format(emb))
