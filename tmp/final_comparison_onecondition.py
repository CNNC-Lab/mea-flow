...
states = load_data(conditons=['n2'], wells=[1, 2, 3, 4])
...
with open('./plots/comparison/different-wells-same-condition/{}.pkl'.format(emb), 'wb') as f:
...
plt.savefig('./plots/comparison/different-wells-same-condition/comp_{}.pdf'.format(emb))
